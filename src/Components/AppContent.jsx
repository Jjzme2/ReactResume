...
import {Card, SkillCard, GhostCard, LinkListCard} from "./Cards"
import {ListItemBlock, QuoteBlock} from "./Blocks"
...
function createSkillCard(sc){
  ...
  // //Update Quote
  // let RanQuote = function GetRandomQuote() {
...
export function LeftFloatView(){
  <div>
    <h1 className="center-text">Links</h1>
...
export function CentralBody(){
  ...
  return (<div>
     ...
     <p className="centered-text">{curTime}</p>
